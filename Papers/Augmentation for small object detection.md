...
当我们在 augmented 验证集上评估时，小目标的性能提升了 38%(mAP=0.161)，表明训练后的模型有效地overfit 到“粘贴”的小对象上，但不一定适合于原始的小对象。我们猜测这是由于人工复制的不完美性导致的，例如粘贴的目标 mask 和 background 亮度差，这些相对容易被神经网络发现。
