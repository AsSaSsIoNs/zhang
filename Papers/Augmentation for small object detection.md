...
首先通过对包含小目标的图像进行 oversampling，可以很容易地提高小对象的性能。其次，提出了一种基于复制粘贴小对象的 augmentation 算法。与目前最先进的方法 Mask R-CNN 相比，我们在 MS COCO 上实现了 9.7%9.7% 的实例分割和 7.1%7.1% 的目标检测相对改进。实验证明，所提出的增强方法可以在对小目标和大目标的预测质量之间进行权衡。 
